      ...
      subroutine binary
!******************************************************************************
!     This program synthesizes a section of a spectroscopic binary star
!     spectrum, using one model atmosphere for the primary and one model
!     for the secondary, and then compares it to an observed spectrum.
!******************************************************************************
...
!*****finish the syntheses
      call finish (1)
      istat = ivcleof(4,1)
      if (control .ne. 'gridend') go to 1


!*****combine the synthetic spectra for plotting
!      call binplotprep


!*****now plot the spectrum, maybe iterating abundances, and end the program
