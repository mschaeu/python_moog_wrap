...
!******************************************************************************
!     This routine determines the correlation of array 'x' and array 'y',
!     comparing array elements 'i' in 'x' with elements 'i+ishift';
!     the number of points in each array is assumed to be equal.
!******************************************************************************
