      ...
      subroutine curve
!******************************************************************************
!     This routine produces a curve-of-growth for a single line
!******************************************************************************
...
!*****increment the log(gf) value backward by rwstep and redo the calculations
!     until the end (rwlow) is reached
31    call oneline (2)
...
!*****increment the log(gf) value forward by rwstep and redo the calculations
!     until the end (rwhigh) is reached
...
!*****end the computations with a summary print
