      ...
      subroutine ewfind
!******************************************************************************
!     This routine predicts equivalent widths for individual atomic lines
!******************************************************************************
...
!*****open the files for standard output and summary curves-of-growth
      nf1out = 20
      lscreen = 4
...
!*****set some parameters and write header stuff to output
      ewsynthopt = +1
      mode = 1
      call linlimit
      lim1obs = lim1line
...
!*****run single line computations once to predict the EW for each line
...
!*****(re)compute the line optical depth at line center and the C_d curve
         do i=1,ntau
...
!*****compute layer where continuum optical depth > 1
         do i=1,ntau
...
!     compute layer where line center optical depth > 1
...
!     compute layer where line center plus continuum optical depth > 1
20       do i=1,ntau
...
!*****end the abundance computations
      call finish (0)
      return
