...
!******************************************************************************
!     This routine computes a weighted mean EW for one line from a set
!     of models
!******************************************************************************
...
!*****start the computations for a line
...
!*****for each model, interpolate in the curve-of-growth to get an EW_calc
!     for the assumed abundance
      do mmod=1,modtot
...
!*****add this EW to the total, weighting it by flux*radius^2*relcount
