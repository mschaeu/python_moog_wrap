      ...
      subroutine fluxplot
!******************************************************************************
!     This subroutine creates plots of flux curves
!******************************************************************************
...
!*****start the plot via some setup calls
...
!*****draw and label the box for the curve-of-growth
      call sm_expand (0.6)
      call sm_lweight (1.4)
      call defcolor (1)
      call sm_box (0,0,0,0)
...
!*****plot the computed flux curve points
      call sm_expand (1.0)
      call defcolor (2)
      style(1) = 240.7
...
!*****compute total flux and effective temperature; exit normally
      do i=1,ntot
