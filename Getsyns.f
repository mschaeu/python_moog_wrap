...
!******************************************************************************
!     This routine commands the syntheses to be done (or resyntheses if
!     abundances or isotopic ratios are changed)
!******************************************************************************
...
!*****if the syntheses need to be redone: first rewind the output files,
!     then close/reopen line list(s), then rewrite model atmosphere output
      if (choice .eq. 'n') then
         call chabund
...
!*****a nonsense situation:  the line list read in successfully at the
!*****start, but now there is a problem on re-synthesis
10    write (*,1108)
      stop
