...
!******************************************************************************
!     this routine serves to open files for reading, and does minimal
!     error checking.
!******************************************************************************
...
!  decide on the file status desired
      jstat = 0
...
!  write out the appropriate message about this file
5     nchars = charcount
...
!  open the file specified by the user, earlier or now
...
!  here are the file reading error messages;
!  if an expected file is not found, 118 is the error code for SunOS, 1018
!  is for Solaris, and 2 is for Redhat Linux operating systems.
10    if (jstat .eq. 118 .or. jstat .eq. 1018 .or. &
         ...
         charcount = nchars
         go to 5
!  if a file is in danger of being over-written, 117 is the error code for 
!  SunOS, 1017 is for Solaris, and 128 is for Redhat Linux operating systems.
