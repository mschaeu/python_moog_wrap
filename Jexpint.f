...
!******************************************************************************
!     This routine computes the n'th exponential integral of x
!     ******* notice limits on x for this program!!! ******
...
!     jd does not output ex to save moog call re-write
!              rex,  expf(-x)
!     jd
...
!     power series expansion about zero
  200 arg=dlog(abs(xm))
      arg=((((((((((((((((.41159050d-14*xm+.71745406d-13)*xm+.76404637d-12) &
      *xm+.11395905d-10)*xm+.17540077d-9)*xm+.23002666d-8)*xm+.27536018d-7) &
      *xm+.30588626d-6)*xm+.31003842d-5)*xm+.28346991d-4)*xm+.23148057d-3) &
      *xm+.0016666574)*xm+.010416668)*xm+.055555572)*xm+.25)*xm+ &
