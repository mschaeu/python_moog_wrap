...
!******************************************************************************
!     This routine is an output subroutine for things having to do with
!     lines.  
!            number = 1 gives input line data information
!******************************************************************************
...
!*****here the line data are output to "standard_out"; all relevant 
!     drivers use this
!     if you don't want any line output, linprintopt=0 will exit the routine
1     if (linprintopt .lt. 1) return
!     if you want standard output, linprintopt=1 is chosen
!     linprintopt>=2 outputs ionization potentials, charges, masses,
!                            reduced masses for molecules, 
!     linprintopt>=3 outputs partition functions
!     lineprintop =4 outputs line-center opacities
...
!*****here the STRONG line data are output; MOOG assumes that no
!     molecular line can possibly be in this category
...
!*****results of force-fitting EW to yield abundances are output here
!     look here also for the calls to the trend line calculations
