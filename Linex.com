...
!******************************************************************************
!     this common block has variables related to the lines.  Most
!     input quantities typically have single dimensions, while the
!     things that are computed for each line at each atmosphere level
!     have double dimensions.  The variables "a", "dopp", and
!     "kapnu0" are often over-written with plotting data,
!     so leave them alone or suffer unspeakable programming tortures.
!******************************************************************************
