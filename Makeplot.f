...
!******************************************************************************
!     This subroutine does the plot-package-specific commands to begin
!     a plot, then calls the specific plot drawing routine, then ends the
!     plot.
!******************************************************************************
...
!  open the plot device: screen terminal
...
!  open the plot device: hardcopy sent to printer
...
!  open the plot device: postscript file
...
!  issue standard beginning commands
      call sm_graphics
      call sm_erase


!  call the routine that makes the desired plot
...
!  issue standard ending commands; exit normally
      if (plotroutine(1:4) .eq. 'file') then
