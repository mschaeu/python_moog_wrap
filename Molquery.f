      ...
      subroutine molquery
!******************************************************************************
!     This routine discovers whether a species being analyzed in EW 
!     predicting of force-fitting mode is involved in molecular equilibrium 
!     (=M.E.) calculations as well; the variables is set appropriately
!******************************************************************************
...
!*****the species is an atom:
!*****search for it in the list of elements done in M.E.
...
!*****the species is a molecule:
!*****halt if M.E. wasn't done or didn't include this species
      else
         if (neq .eq. 0) then
            lscreen = lscreen + 2
...
!*****if molecule is a hydride, the non-H element will be varied
...
!*****for other molecules, the user specifies which element will be varied
         else
