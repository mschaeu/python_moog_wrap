...
!******************************************************************************
!    This routine clears to the end of the screen, beginning with the
!    position row=y, column=x. The cursor is then placed at (y,x)
!******************************************************************************
...
!
!    This routine writes out a string of characters from 'arr',
!    with the first character beginning at row=y, column=x. The length
!    of the string may be at most 79 characters, and this routine
!    will not write on the 80th column or the 25th row of the screen.
!
       include 'Pstuff.com'
...
!
!    This routine moves the cursor to position row=y, column=x.
!    It checks to be sure that y does not exceed 'maxline', and x does not
!    exceed 79 (the screen limits).
!
       include 'Pstuff.com'
       integer y,x
       character esc*1
...
!    This routine clears to the end of a line, beginning with the current
!    cursor position.
!
       character*1 esc
!
...
!    
!    This routine either turns on the bold-face lettering, if on=1,
!    or turns it off, if on=0
!
       integer on
       character*1 esc
!
...
!
!    This routine either turns on the underlining of text, if on=1,
!    or turns it off.
!
       integer on
       character*1 esc
