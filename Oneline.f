...
!******************************************************************************
!     This routine computes a single line profile                       
!******************************************************************************
...
!*****set an arbitrary maximum # of wavelength points to compute 
!     the line profile
      maxsteps = 100


!*****get started; calculate an initial step size; wavestep only is 
!*****used in synpop
...
!*****calculate continuous opacity and intensity/flux at line wavelength 
      wave = wave1(lim1)                                                
...
!*****check the wavelength step size; expand/contract as necessary
      if (wavestep .eq. 0.) then
         wave = wave1(lim1)
         call taukap
         call cdcalc(2)
...
!*****calculate wavelength dependent line quantities, and the line depth
!     until the depth is very small in the line wing
      wave = wave1(lim1)                                                
      do n=1,maxsteps
         dellam(n) =  (n-1)*st1
