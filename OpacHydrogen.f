!******************************************************************************
!  The subroutines needed to calculate the H I b-f, H I f-f, H- b-f, and
!  H- f-f opacities are in this file.  These are from ATLAS9.
!******************************************************************************
...
!  It returns the cross-section times the number density of H- particles.
!******************************************************************************
...
!  Bell and Berrington (1987, J.Phys.B, 20, 801-806)
...
!  fill some arrays once and for all
      if (istart .eq. 0) then
         istart = 1
!  91.134 number taken from Bell & Berrington
         do iwave=1,22
...
!  .754209 Hotop & Lineberger (1985, J. Phys. Chem. Ref. Data, 14,731-752)
      if (modelnum .ne. modcount) then
         modcount = modelnum
         do i=1,ntau
...
!  main opacity computation yielding "aHminus"
...
!******************************************************************************
!  this is a linear interpolation scheme.  The arrays "xold" and "xnew" 
...
!******************************************************************************
!  This is an interpolation scheme that is copied blindly from ATLAS. 
!  I decided that it would be too dangerous to re-write this one.
!******************************************************************************
