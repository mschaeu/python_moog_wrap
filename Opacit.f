...
!******************************************************************************
!     This routine calculates the continuous opacity *kaplam* or            
!     *kapref* and optical depth *taulam* as needed. the formulas are       
!     ones lifted from the write-up of program *atlas*                      
!******************************************************************************
...
!*****add in an arbitrary amount of "extra" continuous opacity;
!     this is a pure fudge factor, so experiment with care
...
!*****compute an optical depth array at this wavelength, and exit
      if (modeop .ne. 1) then
         do  i=1,ntau
...
!*****here is the assignment of opacities kaplam to kapref; exit normally
      do i=1,ntau
         kapref(i) = kaplam(i)
      enddo
...
!*****here is an internal tauref check on the externally read in tau scale;
!     then exit normally
      do i=1,ntau
