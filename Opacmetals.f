...
!******************************************************************************
!  The subroutines needed to calculate the Mg I, Mg II, Al I, Si I, Si II,
!  and Fe I b-f opacities are in this file.  These are from ATLAS9.
!******************************************************************************
      ...
      subroutine opacC1
!******************************************************************************
!     This routine computes the bound-free absorption due to C I.
!******************************************************************************
...
!  Burke, P.G. and Taylor, K.T. 1979, J. Phys. B, 12, 2971-2984.
      if (modelnum.ne.modcount .or. freq.ne.freq1) then
         ...
         x1100 = 0.
!        P2 3P   1
!  I AM NOT SURE WHETHER THE CALL TO SEATON IN THE NEXT STATEMENT IS
!  CORRECT, BUT IT ONLY AFFECTS THINGS BELOW 1100A
...
!  initialize some quantities for each new model atmosphere or new frequency;
!  there are two edges, one at 824 A and the other at 1169 A
      if (modelnum.ne.modcount .or. freq.ne.freq1) then
         freq1 = freq
...
!  initialize some quantities for each new model atmosphere or new frequency;
!  the absorption begins at 4762 A.
      if (modelnum.ne.modcount .or. freq.ne.freq1) then
         freq1 = freq
         waveno = freq/2.99792458d10
