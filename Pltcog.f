...
!  call up the curve-of-growth plot
...
!  make a hardcopy, write to a postscript file, point at a place on the
!  screen, try a new model atmosphere, or replot?
