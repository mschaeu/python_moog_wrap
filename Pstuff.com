...
!******************************************************************************
!     these common block holds parameters and arrays need in the
!     plotting routines; the second common block puts character variables
!     in their own separate common statement.
!******************************************************************************
      ...
      real*4        chunk(500000,5), xsyn(500000), dev(500000), &
                    ysyn(500000), zsyn(500000), &
