...
!******************************************************************************
!     this routine opens the table file containing information for a stellar
!     population, and reads the data in that file; the information is a
!     bit different for "abpop" and "synpop"
!******************************************************************************
...
!*****read the table input for integrated light EW matching
      if (option .eq. 1) then
...
!*****read the table input for integrated light spectrum syntheses
      else
         nabs = 0
         nisos = 0
...
!*****close the model input file, exit normally
