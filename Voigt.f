...
!******************************************************************************
!     This routine calculates the voigt function using the approximations
!     found in the *new series-astronomy and astrophysics* volume of
!     landolt-bornstein.
!******************************************************************************
...
!  case 1, a .gt. 1.4 or (a .gt. 0.2 and a+v .gt. 3.2)
      u = 1.4142136*(a2 + v2)                  
      voigt = 0.7978847*a/u*(1.0 + (3.0*v2-a2)/u**2 + (15.0*v2*v2 &
       -30.0*a2*v2+3.0*a2*a2)/u**4)
...
!  case 2,  0.2 .lt. a .le. 1.4 and a+v .le. 3.2
