...
!******************************************************************************
!     this routine returns the wavelength of a given channel number
!******************************************************************************
...
!*****no wavelength solution exists
      if (c(1).eq.0. .or. c(2).eq.0.) then
         wavecalc = point

!*****an ordinary polynomial solution
      else
         dn = point
...
!*****a Chebyshev polynomial solution
