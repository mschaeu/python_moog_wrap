      ...
      subroutine weedout                   
!******************************************************************************
!     This routine goes through an initial line list and culls from it
!     absorption lines that are not substantial contributors.  This is
!     done in a simple fashion by eliminating lines weaker than X, where
!     X = kapnu/kaplam at the approximate line wavelength, calculated
!     at a continuue optical depth of 0.5.  The user will be prompted for
...
!*****open the files for: standard output, lines to be kept, and lines
!     to be heaved out
      nf1out = 20     
      lscreen = 4
...
!*****open the initial line list file
      nflines = 31
      lscreen = lscreen + 2
...
!*****ask the user about the value of X
      lscreen = lscreen + 2
...
!*****compute the line opacities
      call inlines (3)
1     call nearly (1)


!*****calculate continuum quantities at the line list wavelength middle
...
!*****divide the lines into keepers and discards
      do j=1,nlines
